...
export default async function HomePage() {
  ...
  let products: Product[] = [
    ...
    {
      id: 'plano-5-telas',
      name: '5 Telas JN TELAS',
      screens: 5,
      price_cents: 17000,
      description: 'Mais economia por tela',
    },
    {
      id: 'plano-10-telas',
      name: '10 Telas JN TELAS',
      screens: 10,
      price_cents: 33000,
  ...
  // A Vercel Drop não leva automaticamente o arquivo .env.local.
  ...
  return (
    <div className="flex min-h-dvh flex-col">
      ...
      <main className="flex-1">
        <Hero />
        <Benefits />
        <Pricing products={(products as Product[]) ?? []} isLoggedIn={!!user} />
        <Faq />
        <Support />
      </main>
      <Footer />
